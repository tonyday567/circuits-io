...
-- at runtime using the environment variable circuits_io_bindir.
...
-- environment variable circuits_io_libdir.
...
-- using the environment variable circuits_io_dynlibdir.
...
-- runtime using the environment variable circuits_io_datadir.
...
-- variable circuits_io_libexedir.
...
-- using the environment variable circuits_io_sysconfdir.
...
libdir     = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf/circuits-io-0.1.0.0-inplace"
dynlibdir  = "/Users/tonyday567/.cabal/lib/aarch64-osx-ghc-9.14.1-bcbf"
datadir    = "/Users/tonyday567/.cabal/share/aarch64-osx-ghc-9.14.1-bcbf/circuits-io-0.1.0.0"
libexecdir = "/Users/tonyday567/.cabal/libexec/aarch64-osx-ghc-9.14.1-bcbf/circuits-io-0.1.0.0"
sysconfdir = "/Users/tonyday567/.cabal/etc"

getBinDir     = catchIO (getEnv "circuits_io_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "circuits_io_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "circuits_io_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "circuits_io_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "circuits_io_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "circuits_io_sysconfdir") (\_ -> return sysconfdir)
